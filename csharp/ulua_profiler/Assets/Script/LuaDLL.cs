namespace LuaInterface
{
    ...
    public delegate string LuaChunkReader(IntPtr luaState,ref ReaderInfo data,ref IntPtr size);

    public delegate int LuaFunctionCallback(IntPtr luaState);

	public delegate void LuaTimerFunc(IntPtr timer);

	public delegate UInt64 LuaGetSeconds(UInt64 marker);

	public unsafe delegate void LuaDumper(IntPtr proto,IntPtr path);
...
//#endif
		...
		{
			return lua_newuserdata(luaState, (IntPtr)size);
		}
		...
		public static IntPtr lua_tolstring(IntPtr luaState, int index, out int strLen)
		{
			...
			IntPtr r = lua_tolstring(luaState, index, out c);
			strLen = (int)c;
			return r;
		}
		...
		//[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		//public static extern void lua_pushinteger(IntPtr luaState, System.IntPtr number);
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern void lua_pushboolean(IntPtr luaState, bool value);
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		public static extern void lua_pushlstring(IntPtr luaState, byte[] str, IntPtr size);
		[DllImport(LUADLL,CallingConvention=CallingConvention.Cdecl)]
		...
		{
			lua_pushlstring(luaState, str, (IntPtr)size);
		}
		public static int luaL_loadbuffer(IntPtr luaState, byte[] buff, int size, string name)
		{
			return luaL_loadbuffer(luaState, buff, (IntPtr)size, name);
		}
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		...
		// Unity Windows editor only
		// bigtick functions
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		public static extern void lua_set_bigtick(IntPtr L,int enable);
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		public static extern void lua_update_bigtick(IntPtr L);
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		public static extern void lua_set_bigtick_timer(IntPtr L, LuaTimerFunc func, LuaGetSeconds second_func);
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		public static extern void lua_set_bigtick_dumper(IntPtr L, LuaDumper dumper);
		[DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
		public static extern void lua_dump_bigtick(IntPtr L, IntPtr path);
#endif
	}
}
